...
class UserModelTest(TestCase):
    ...
    def test_duplicate_email(self):
        ...
        with self.assertRaises(
            Exception
        ):  # MongoEngine might raise different exception
            User.create_user(
                email="duplicate@example.com", username="user2", password="password123"
            )
    ...
    def test_duplicate_username(self):
        ...
        """
        User.create_user(
            email="user1@example.com", username="duplicateuser", password="password123"
        )
        with self.assertRaises(
            Exception
        ):  # MongoEngine might raise different exception
